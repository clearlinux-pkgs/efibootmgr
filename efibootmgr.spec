...
Source0  : https://github.com/rhinstaller/efibootmgr/archive/15.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1494609969
make V=1  %{?_smp_mflags} EFIDIR=org.clearlinux
